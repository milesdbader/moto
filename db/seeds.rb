...
grain_ingredients = ['Pasta', 'Wholegrain Bread', 'Wheat flour', 'White flour', 'Red rice', 'Brown rice', 'White rice', 'Potatoes', 'Chickpeas', 'Soybeans', 'Artichoke', 'Potato', 'Parsnips', 'Broccoli', 'Pumpkin', 'Quinoa', 'Almonds', 'Pistachios']
vegetable_ingredients = ['Kalamata olives', 'Spinach', 'Bell peppers', 'Kale', 'Alfalfa sprouts', 'Sweet potatoes', 'Broccoli', 'Endive', 'Fennel', 'Basil', 'Thyme', 'Sage', 'Rosemary', 'Parsely', 'Arugula', 'Chives', 'Peas', 'Beets', 'Carrots', 'Tomato', 'Garlic', 'Onion', 'Cauliflower', 'Seaweed']
...
Challenge.build!(tamara, david, accepted: true, expiration: Time.new + 259200, mode: 'creative', protein: Ingredient.find_by(name: 'Turkey'), grain: Ingredient.find_by(name: 'Quinoa'), dairy: Ingredient.find_by(name: 'Cream cheese'), vegetable: Ingredient.find_by(name: 'Spinach'))
Challenge.build!(tamara, david, accepted: true, expiration: Time.new + 256200, mode: 'classic', recipe_id: Recipe.find_by(name: "Simple Pumpkin Soup").id, protein: Ingredient.find_by(name: 'Turkey'), grain: Ingredient.find_by(name: 'Quinoa'), dairy: Ingredient.find_by(name: 'Cream cheese'), vegetable: Ingredient.find_by(name: 'Spinach'))
Challenge.build!(tamara, miles,  accepted: true, expiration: Time.new + 259200, mode: 'classic', recipe_id: Recipe.find_by(name: "Crispy Breaded Cauliflower Wings").id, protein: Ingredient.find_by(name: 'Turkey'), grain: Ingredient.find_by(name: 'Quinoa'), dairy: Ingredient.find_by(name: 'Cream cheese'), vegetable: Ingredient.find_by(name: 'Spinach'))
Challenge.build!(eyal, john,  accepted: true, expiration: Time.new + 254200, mode: 'classic', recipe_id: Recipe.find_by(name: "8-Minute Sweet Potatoes").id, protein: Ingredient.find_by(name: 'Turkey'), grain: Ingredient.find_by(name: 'Quinoa'), dairy: Ingredient.find_by(name: 'Cream cheese'), vegetable: Ingredient.find_by(name: 'Spinach'))
Challenge.build!(eyal, hilary,  accepted: true, expiration: Time.new + 252200, mode: 'classic', recipe_id: Recipe.find_by(name: "Sautéed Kale with Lemon, Tahini & Hemp Seeds").id, protein: Ingredient.find_by(name: 'Turkey'), grain: Ingredient.find_by(name: 'Quinoa'), dairy: Ingredient.find_by(name: 'Cream cheese'), vegetable: Ingredient.find_by(name: 'Spinach'))
Challenge.build!(tamara, eyal, accepted: true, expiration: Time.new + 279000, mode: 'creative', protein: Ingredient.find_by(name: 'Egg'), grain: Ingredient.find_by(name: 'White flour'), dairy: Ingredient.find_by(name: 'Milk'), vegetable: Ingredient.find_by(name: 'Kalamata olives'))
...
Challenge.build!(tamara, john,  accepted: true, mode: 'classic', recipe_id: Recipe.find_by(name: "Balsamic Portobello Burgers with Caramelized Onions & Garlic Aioli").id, protein: Ingredient.find_by(name: 'Turkey'), grain: Ingredient.find_by(name: 'Quinoa'), dairy: Ingredient.find_by(name: 'Cream cheese'), vegetable: Ingredient.find_by(name: 'Spinach'))
Challenge.build!(eyal, calvin,  accepted: true, mode: 'classic', recipe_id: Recipe.find_by(name: "Green Pea Curry Hummus").id, protein: Ingredient.find_by(name: 'Turkey'), grain: Ingredient.find_by(name: 'Quinoa'), dairy: Ingredient.find_by(name: 'Cream cheese'), vegetable: Ingredient.find_by(name: 'Spinach'))
...
Challenge.build!(eyal, tristan,  accepted: true, expiration: Time.new + 254200, mode: 'creative', protein: Ingredient.find_by(name: 'Beef'), grain: Ingredient.find_by(name: 'Pumpkin'), dairy: Ingredient.find_by(name: 'Curd'), vegetable: Ingredient.find_by(name: 'Alfalfa sprouts'))
Challenge.build!(eyal, david,  accepted: true, expiration: Time.new + 259200, mode: 'classic', recipe_id: Recipe.find_by(name: "4-Ingredient Citrus & Melon Spritzer").id, protein: Ingredient.find_by(name: 'Turkey'), grain: Ingredient.find_by(name: 'Quinoa'), dairy: Ingredient.find_by(name: 'Cream cheese'), vegetable: Ingredient.find_by(name: 'Spinach'))

# these ones are pending
Challenge.build!(eyal, tristan,  accepted: false, expiration: Time.new + 259200, mode: 'creative', protein: Ingredient.find_by(name: 'Black beans'), grain: Ingredient.find_by(name: 'Broccoli'), dairy: Ingredient.find_by(name: 'Buttermilk'), vegetable: Ingredient.find_by(name: 'Arugula'))
Challenge.build!(eyal, calvin,  accepted: false, expiration: Time.new + 259200, mode: 'classic', recipe_id: Recipe.find_by(name: "1-Pan Mexican Shredded Chicken").id, protein: Ingredient.find_by(name: 'Black beans'), grain: Ingredient.find_by(name: 'Broccoli'), dairy: Ingredient.find_by(name: 'Buttermilk'), vegetable: Ingredient.find_by(name: 'Arugula'))
...
Challenge.build!(miles, eyal,  accepted: false, mode: 'classic', recipe_id: Recipe.find_by(name: "Easy Tofu Pad Thai").id, protein: Ingredient.find_by(name: 'Turkey'), grain: Ingredient.find_by(name: 'Quinoa'), dairy: Ingredient.find_by(name: 'Cream cheese'), vegetable: Ingredient.find_by(name: 'Spinach'))
...
# chicken bowl
c2 = Challenge.build!(miles, david, accepted: true, expiration: Time.new(2020, 03, 10), mode: 'creative', protein: Ingredient.find_by(name: 'Chicken'), grain: Ingredient.find_by(name: 'Quinoa'), dairy: Ingredient.find_by(name: 'Cream'), vegetable: Ingredient.find_by(name: 'Corn'), voting_end: Time.now + 6000000)
...
# spinach omelette
c6 = Challenge.build!(miles, david, accepted: true, expiration: Time.new(2020, 03, 06), mode: 'creative', protein: Ingredient.find_by(name: 'Egg'), grain: Ingredient.find_by(name: 'Wheat flour'), dairy: Ingredient.find_by(name: 'Butter'), vegetable: Ingredient.find_by(name: 'Parsely'), voting_end: Time.now + 6000000)
