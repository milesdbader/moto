...
Challenge.build!(tamara, eyal, accepted: true, expiration: Time.new + 259000, mode: 'creative', protein: Ingredient.find_by(name: 'Egg'), grain: Ingredient.find_by(name: 'White flour'), dairy: Ingredient.find_by(name: 'Milk'), vegetable: Ingredient.find_by(name: 'Kalamata olives'))
...
Challenge.build!(eyal, tristan,  accepted: true, expiration: Time.new + 259200, mode: 'creative', protein: Ingredient.find_by(name: 'Beef'), grain: Ingredient.find_by(name: 'Pumpkin'), dairy: Ingredient.find_by(name: 'Curd'), vegetable: Ingredient.find_by(name: 'Alfalfa sprouts'))
