...
Challenge.build!(tamara, eyal, accepted: true, expiration: Time.new(2020, 03, 07), mode: 'creative', protein: Ingredient.find_by(name: 'Egg'), grain: Ingredient.find_by(name: 'White flour'), dairy: Ingredient.find_by(name: 'Milk'), vegetable: Ingredient.find_by(name: 'Kalamata olives'))
...
Challenge.build!(eyal, tristan,  accepted: true, expiration: Time.new(2020, 03, 10), mode: 'creative', protein: Ingredient.find_by(name: 'Beef'), grain: Ingredient.find_by(name: 'Pumpkin'), dairy: Ingredient.find_by(name: 'Curd'), vegetable: Ingredient.find_by(name: 'Alfalfa sprouts'))
Challenge.build!(eyal, david,  accepted: true, expiration: Time.new(2020, 03, 11), mode: 'classic', recipe_id: Recipe.find_by(name: "4-Ingredient Citrus & Melon Spritzer").id, protein: Ingredient.find_by(name: 'Turkey'), grain: Ingredient.find_by(name: 'Quinoa'), dairy: Ingredient.find_by(name: 'Cream cheese'), vegetable: Ingredient.find_by(name: 'Spinach'))
